...
const auth = (req, res, next) => {
    ...
    try {
        const decode = jwt.verify(token, SECRET_PASSWORD);
...
(function (HTTPStatusCode) {
    HTTPStatusCode[HTTPStatusCode["SomethingWentWrong"] = 404] = "SomethingWentWrong";
    HTTPStatusCode[HTTPStatusCode["InvalidInput"] = 411] = "InvalidInput";
